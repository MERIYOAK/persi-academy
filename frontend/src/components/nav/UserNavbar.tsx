        ...
        <div className="flex justify-between h-14 sm:h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2 transition-transform duration-200 hover:scale-105">
              ...
              <span className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800">YT Academy</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            {isAuthenticated ? (
              ...
              <>
                <Link
                  to="/login"
                  className="text-gray-700 hover:text-red-600 transition-all duration-300 ease-in-out transform hover:scale-105"
                >
                  Login
                </Link>
                <Link
                  to="/register"
                  className="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 shadow-lg hover:shadow-xl"
                >
                  Sign Up
                </Link>
              </>
             ...
             {isAuthenticated ? (
               <div className="px-4 py-2">
                 ...
                 <div className="space-y-2">
                   <Link
                     to="/dashboard"
                     className="flex items-center px-4 py-3 text-sm sm:text-base font-medium text-gray-700 hover:text-red-600 transition-all duration-300 ease-in-out rounded-lg hover:bg-gray-50"
                     onClick={() => setIsOpen(false)}
                   >
                   ...
                   <button
                     ...
                     className="w-full text-left flex items-center px-4 py-3 text-sm sm:text-base font-medium text-gray-700 hover:text-red-600 transition-all duration-300 ease-in-out rounded-lg hover:bg-gray-50"
                   >
                     <svg className="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
